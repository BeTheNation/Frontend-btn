...
export default function RootPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#111214] text-white overflow-hidden">
        ...
        <div className="self-stretch px-[122px] py-12 inline-flex flex-col justify-center items-start gap-8">
          <div className="self-stretch h-[337px] p-12 bg-gradient-to-r from-black/0 to-black/20 rounded-2xl shadow-[0px_1px_2px_0px_rgba(16,24,40,0.06)] shadow-[0px_1px_3px_0px_rgba(16,24,40,0.10)] outline outline-1 outline-offset-[-1px] outline-[#323232] inline-flex justify-start items-start gap-6 overflow-hidden">
            <div className="flex-1 self-stretch inline-flex flex-col justify-start items-start gap-6">
              <div className="bg-gradient-to-b from-[#f1f1ef] to-[#f1f1ef]/15  text-transparent tracking-[-3%] bg-clip-text justify-start text-[#f1f1ef] text-2xl sm:text-4xl md:text-[64px] font-medium font-['Inter'] leading-tight md:leading-[70px]">
                Live<br />Leaderboard
              </div>
      ...
      {/* Live Countryscore Section - Enhanced with gradient background and card layout */}
      <section className="py-20 mt-40 px-4 relative">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {/* Left column - Title and description */}
            <div className="md:col-span-1">
              <div className="self-stretch text-center md:text-left mb-8">
                <div className="text-center mb-4 bg-gradient-to-b from-[#f1f1ef] to-[#f1f1ef]/15 text-transparent tracking-[-3%] bg-clip-text justify-start text-[#f1f1ef] text-[32px] font-medium font-['Inter'] leading-[38px]">
                  Live Countryscore Data
                </div>
                <div className="max-w-[600px] mx-auto md:mx-0">
                  <p className="text-[#777777] text-base font-medium font-['Inter'] leading-7">
            ...
            {/* Right column - Live Countryscore card */}
            <div className="md:col-span-1">
              <div className="relative bg-[#202327] rounded-3xl shadow-[0px_1px_2px_0px_rgba(16,24,40,0.06)] shadow-[0px_1px_3px_0px_rgba(16,24,40,0.10)] outline outline-[0.50px] outline-offset-[-0.50px] outline-[#323232] p-6 flex flex-col justify-start items-start gap-6">
                {/* Header */}
                <div className="self-stretch inline-flex justify-start items-center gap-4">
                  <div className="flex-1 justify-start text-white text-lg font-medium font-['Inter'] leading-7">
                    Live Countryscore
                ...
                <div className="self-stretch h-[200px] relative">
                  ...
                  <div className="absolute inset-0 flex flex-col justify-between">
                    {[...Array(6)].map((_, i) => (
                      <div
                        key={i}
                        className="w-full h-0 left-0 top-0 absolute outline outline-[0.50px] outline-offset-[-0.25px] outline-[#323232]"
                      ></div>
                    ))}
                  </div>
                  ...
                  {/* X-axis labels */}
                  <div className="self-stretch px-6 inline-flex justify-between items-center absolute bottom-0 left-0 right-0">
                    {[
                      "28 Apr",
                      "29 Apr",
                      "30 Apr",
      ...
      {/* Market Trends Section - Enhanced with gradient background and card layout */}
      <section className="py-20 mt-40 px-4 relative">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {/* Left column - Title and description */}
            ...
            {/* Right column - Market Trends card */}
            <div className="md:col-span-1">
              <div className="relative bg-[#202326] rounded-3xl shadow-[0px_1px_2px_0px_rgba(16,24,40,0.06)] shadow-[0px_1px_3px_0px_rgba(16,24,40,0.10)] flex flex-col justify-between items-start p-6">
                {/* Header */}
